...
#'   - `"spot"`: for endpoint [api/v3/exchangeInfo](https://binance-docs.github.io/apidocs/spot/en/#exchange-information). The ip weight is 20.
#'   - `"fapi"`: for endpoint [fapi/v1/exchangeInfo](https://binance-docs.github.io/apidocs/futures/en/#exchange-information). The ip weight is 1.
#'   - `"dapi"`: for endpoint [dapi/v1/exchangeInfo](https://binance-docs.github.io/apidocs/delivery/en/#exchange-information). The ip weight is 1.
#'   - `"eapi"`: for endpoint [eapi/v1/exchangeInfo](https://binance-docs.github.io/apidocs/voptions/en/#exchange-information). The ip weight is 1.
#'   
...
#'
#' @keywords rest market exchangeInfo
