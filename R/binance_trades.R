...
#'   - `"spot"`: for endpoint [api/v3/aggTrades](https://binance-docs.github.io/apidocs/spot/en/#old-trade-lookup).
#'   - `"fapi"`: for endpoint [fapi/v1/aggTrades](https://binance-docs.github.io/apidocs/futures/en/#old-trade-lookup).
#'   - `"dapi"`: for endpoint [dapi/v1/aggTrades](https://binance-docs.github.io/apidocs/delivery/en/#old-trade-lookup).
