...
#'   - `"fapi"`: for endpoint [fapi/v1/openInterestHist](https://binance-docs.github.io/apidocs/futures/en/#open-interest-statistics). The ip weight is 1.
#'   - `"dapi"`: for endpoint [dapi/v1/openInterestHist](https://binance-docs.github.io/apidocs/delivery/en/#open-interest-statistics). The ip weight is 1.
#'   
...
#'                            to = NULL)
#'
#' @keywords rest market openInterestHist
#' @rdname binance_open_interest_hist
#' @name binance_open_interest_hist
#' @export

binance_open_interest_hist <- function(pair, api, interval, from, to, contract_type, quiet = FALSE){
