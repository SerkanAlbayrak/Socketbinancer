...
#'   - `"fapi"`: for endpoint [fapi/v1/openInterest](https://binance-docs.github.io/apidocs/futures/en/#open-interest). The ip weight is 1.
#'   - `"dapi"`: for endpoint [dapi/v1/openInterest](https://binance-docs.github.io/apidocs/delivery/en/#open-interest). The ip weight is 1.
#'   - `"eapi"`: for endpoint [eapi/v1/openInterest](https://binance-docs.github.io/apidocs/voptions/en/#open-interest). The ip weight is 1.
#'
...
#'
#' @keywords rest market openInterest 
